...
namespace VkPeopleSearchApp.View
{
    ...
    /// </summary>
    public sealed partial class SelectCountryView : Page
    {
        private readonly NavigationHelper _navigationHelper;
        private SelectCountryViewModel _viewModel;
        ...
        protected override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            if (p != null)
            {
                ...
                {
                    var searchParams = (SearchParams) p["params"];
                    _viewModel = new SelectCountryViewModel(searchParams);
